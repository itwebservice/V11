	...
	<tbody>
		...
		while($row_transport_agency = mysqli_fetch_assoc($sq_transport_agency)){
			...
			<tr class="<?= $bg ?>">
				...
				<td>
					<button class="btn btn-info btn-sm" onclick="update_modal(<?= $row_transport_agency['transport_agency_id'] ?>)" title="Update Details"><i class="fa fa-pencil-square-o"></i></button>
