<tr>
        ...
        <td><input class="form-control" type="text" id="total_infant-<?= $offset ?>1" name="total_infant-<?= $offset ?>1" placeholder="Total Infant" title="Total Child" onchange="excursion_amount_calculate(this.id);calculate_exc_expense('tbl_dynamic_exc_booking');validate_balance(this.id);get_auto_values('balance_date','exc_issue_amount','payment_mode','service_charge','markup','save','true','service_charge');" style="width:110px"></td>
        <td><input class="form-control" type="text" id="adult_cost-<?= $offset ?>1" name="adult_cost-<?= $offset ?>1" placeholder="Adult Ticket Cost" title="Adult Ticket Cost" onchange="excursion_amount_calculate(this.id);calculate_exc_expense('tbl_dynamic_exc_booking');validate_balance(this.id)" style="width:142px"></td>
        <td><input class="form-control" type="text" id="child_cost-<?= $offset ?>1" name="child_cost-<?= $offset ?>1" placeholder="Child Ticket Cost" title="Child Ticket Cost" onchange="excursion_amount_calculate(this.id);calculate_exc_expense('tbl_dynamic_exc_booking');validate_balance(this.id)" style="width:142px"></td>
        <td><input class="form-control" type="text" id="infant_cost-<?= $offset ?>1" name="infant_cost-<?= $offset ?>1" placeholder="Infant Ticket Cost" title="Infant Ticket Cost" onchange="excursion_amount_calculate(this.id);calculate_exc_expense('tbl_dynamic_exc_booking');validate_balance(this.id)" style="width:144px"></td>
