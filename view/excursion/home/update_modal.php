							...
							if($sq_entry_count==0){
								...
								while($row_entry = mysqli_fetch_assoc($sq_entry)){
									...
									<tr class="<?= $bg ?>">
										...
										<td><input type="text" id="total_amount-<?= $offset.$count ?>" name="total_amount-<?= $offset.$count ?>" placeholder="Total Cost" title="Activity Cost" value="<?php echo $row_entry['total_cost'] ?>" onchange="validate_balance(this.id);excursion_amount_calculate(this.id,'1');calculate_exc_expense('tbl_dynamic_exc_booking_update','1');" style="width:120px"></td>
