...
while($row_vehicle = mysqli_fetch_assoc($sq_vehicle))
{
	...
	$temp_arr = array ("data"=>array(
		...
		'<button class="btn btn-info btn-sm" data-toggle="tooltip" onclick="edit_modal('.$row_vehicle['entry_id'] .')" title="Update Details"><i class="fa fa-pencil-square-o"></i></button>'),"bg" => $bg
	);
