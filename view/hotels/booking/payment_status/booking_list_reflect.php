...
$temp_arr = array( "data" => array(
	...
	'<button class="btn btn-info btn-sm" onclick="hotel_view_modal('. $row_booking['booking_id'] .')" data-toggle="tooltip" title="View Details" id="view-'. $row_booking['booking_id'] .'"><i class="fa fa-eye" aria-hidden="true"></i></button>',
	...
	'<button class="btn btn-info btn-sm" onclick="payment_view_modal('.$row_booking['booking_id'] .')"  data-toggle="tooltip" title="View Details" id="pview-'. $row_booking['booking_id'] .'"><i class="fa fa-eye" aria-hidden="true"></i></button>',
	number_format($bal, 2),
	$due_date,
	number_format($total_purchase,2),
	'<button class="btn btn-info btn-sm" onclick="supplier_view_modal('. $row_booking['booking_id'] .')" data-toggle="tooltip" title="View Details" id="sview-'. $row_booking['booking_id'] .'"><i class="fa fa-eye" aria-hidden="true"></i></button>',
	$branch_name,
	$emp_name,
