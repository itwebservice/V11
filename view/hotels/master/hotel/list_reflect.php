...
while($row_hotel = mysqli_fetch_assoc($sq_hotel)){
	...
	$temp_arr = array("data" =>array(
		...
		'<button class="btn btn-info btn-sm" onclick="update_modal('.$row_hotel['hotel_id'] .')" data-toggle="tooltip" title="Update Details"><i class="fa fa-pencil-square-o"></i></button><button class="btn btn-info btn-sm" onclick="view_modal('.$row_hotel['hotel_id'].')" data-toggle="tooltip" title="View Details"><i class="fa fa-eye"></i></button>
		'), "bg" => $bg
	);
