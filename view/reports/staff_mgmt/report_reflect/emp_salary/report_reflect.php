    ...
    while($row_emp = mysqli_fetch_assoc($sq_a)){
        ...
        while($sq_sal = mysqli_fetch_assoc($sq_sal1)){ 
          ...
          $temp_arr = array( "data" => array(
              ...
              '<button class="btn btn-info btn-sm" onclick="update_modal('. $sq_sal['salary_id'] .', '.$month .')" data-toggle="tooltip" title="Update Details"><i class="fa fa-pencil-square-o"></i></button>
