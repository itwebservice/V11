...
if($sale_type == 'Excursion'){ 
	...
	while ($row_passport = mysqli_fetch_assoc($sq_passport)) {
		...
		//Purchase
		$sq_purchase = mysqlQuery("select * from vendor_estimate where status!='Cancel' and estimate_type='Excursion Booking' and estimate_type_id ='$row_passport[exc_id]' and status!='Cancel' and delete_status='0'");
		while($sq_pquery = mysqli_fetch_assoc($sq_purchase)){	
			if($sq_pquery['purchase_return'] == 0){
				$total_purchase += $sq_pquery['net_total'];
			}
...
if($sale_type == 'Bus'){
	...
	while ($row_passport = mysqli_fetch_assoc($sq_passport)) {
		...
		//Purchase 
		$sq_purchase = mysqlQuery("select * from vendor_estimate where status!='Cancel' and estimate_type='Bus Booking' and estimate_type_id ='$row_passport[booking_id]' and status!='Cancel' and delete_status='0'");
		while($sq_pquery = mysqli_fetch_assoc($sq_purchase)){	
			if($sq_pquery['purchase_return'] == 0){
				$total_purchase += $sq_pquery['net_total'];
			}
...
if($sale_type == 'Hotel'){
	...
	while ($row_passport = mysqli_fetch_assoc($sq_passport)) {
		...
		//Purchase 
		$sq_purchase = mysqlQuery("select * from vendor_estimate where estimate_type='Hotel Booking' and estimate_type_id ='$row_passport[booking_id]' and status!='Cancel' and delete_status='0'");
		while($sq_pquery = mysqli_fetch_assoc($sq_purchase)){	
			if($sq_pquery['purchase_return'] == 0){
				$total_purchase += $sq_pquery['net_total'];
			}
...
if($sale_type == 'Car Rental'){ 
	...
	while ($row_passport = mysqli_fetch_assoc($sq_passport)) {
		...
		//Purchase 
		$sq_purchase = mysqlQuery("select * from vendor_estimate where status!='Cancel' and estimate_type='Car Rental' and estimate_type_id ='$row_passport[booking_id]' and status!='Cancel' and delete_status='0'");
		while($sq_pquery = mysqli_fetch_assoc($sq_purchase)){	
			if($sq_pquery['purchase_return'] == 0){
				$total_purchase += $sq_pquery['net_total'];
			}
...
if($sale_type == 'Flight Ticket'){ 
	...
	while ($row_passport = mysqli_fetch_assoc($sq_passport)) {
		...
		//Purchase 
		$sq_purchase = mysqlQuery("select * from vendor_estimate where status!='Cancel' and estimate_type='Ticket Booking' and estimate_type_id ='$row_passport[ticket_id]' and status!='Cancel' and delete_status='0'");
		while($sq_pquery = mysqli_fetch_assoc($sq_purchase)){	
			if($sq_pquery['purchase_return'] == 0){
				$total_purchase += $sq_pquery['net_total'];
			}
...
if($sale_type == 'Train Ticket'){ 
	...
	while ($row_passport = mysqli_fetch_assoc($sq_passport)) {
		...
		//Purchase 
		$sq_purchase = mysqlQuery("select * from vendor_estimate where status!='Cancel' and estimate_type='Train Ticket Booking' and estimate_type_id ='$row_passport[train_ticket_id]' and status!='Cancel' and delete_status='0'");
		while($sq_pquery = mysqli_fetch_assoc($sq_purchase)){	
			if($sq_pquery['purchase_return'] == 0){
				$total_purchase += $sq_pquery['net_total'];
			}
...
if($sale_type == 'Miscellaneous'){ 
	...
	while ($row_visa = mysqli_fetch_assoc($sq_query)){
		...
		//Purchase 
		$sq_purchase = mysqlQuery("select * from vendor_estimate where status!='Cancel' and estimate_type='Miscellaneous Booking' and estimate_type_id ='$row_visa[misc_id]' and status!='Cancel' and delete_status='0'");
		while($sq_pquery = mysqli_fetch_assoc($sq_purchase)){	
			if($sq_pquery['purchase_return'] == 0){
				$total_purchase += $sq_pquery['net_total'];
			}
