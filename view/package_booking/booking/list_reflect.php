...
while ($row_booking = mysqli_fetch_assoc($sq_booking)) {
	...
	$temp_arr = array("data" => array(
		...
		'<div class="ava-pic"><span class="avatar h-9 w-9">
								<img class="mask" src="https://lineone.piniastudio.com/images/avatar/avatar-20.jpg" alt="avatar">
							  </span>' . $emp_name . '</div>',
