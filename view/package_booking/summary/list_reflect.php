...
while($row_package = mysqli_fetch_assoc($sq_package)){
	...
	$temp_arr = array( "data" => array(
		...
		'<button class="btn btn-info btn-sm" onclick="package_view_modal('. $row_package['booking_id'] .')" data-toggle="tooltip" title="View Details" id="view-'.$row_package['booking_id'] .'"><i class="fa fa-eye" aria-hidden="true"></i></button>',
		...
		'<button class="btn btn-info btn-sm" onclick="payment_view_modal('.$row_package['booking_id'] .')"  data-toggle="tooltip" title="View Details" id="pview-'.$row_package['booking_id'] .'"><i class="fa fa-eye" aria-hidden="true"></i></button>',
		...
		'<button class="btn btn-info btn-sm" onclick="supplier_view_modal('. $row_package['booking_id'] .')" data-toggle="tooltip" title="View Details" id="sview-'.$row_package['booking_id'] .'"><i class="fa fa-eye" aria-hidden="true"></i></button>',
		$branch_name,
		$emp_name,
