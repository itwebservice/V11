      ...
      <tbody>
        ...
        while( $row_offer = mysqli_fetch_assoc($sq_offer) ){
          ...
          <tr>
            ...
            <td><a class="btn btn-info btn-sm" href="#" onclick="upcoming_tours_update_modal(<?= $row_offer['offer_id'] ?>)" title="Update Offer Details"><i class="fa fa-pencil-square-o"></i></a>
            <button class="btn btn-danger btn-sm" onclick="upcoming_tour_offer_disable(<?php echo $row_offer['offer_id'] ?>)" title="Disable"><i class="fa fa-ban"></i></button></td>
          </tr>
          <?php
        }    
        ?>
