...
while($row_journal = mysqli_fetch_assoc($sq_journal)){
	...
	$temp_arr = array (
		...
		<button class="btn btn-info btn-sm" data-toggle="tooltip" onclick="update_modal('.$row_journal['entry_id'] .')" title="Edit Details" id="edit-'.$row_journal['entry_id'].'"><i class="fa fa-pencil-square-o"></i></button>
