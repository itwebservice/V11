...
{
	var base_url = $('#base_url').val();
	$.post(base_url+'view/finance_master/ledger_master/view/display_history.php', {module_entry_id : module_entry_id, module_name : module_name , finance_transaction_id : finance_transaction_id, payment_perticular : payment_perticular,ledger_name : ledger_name,type:type}, function(data){
