...
while($row_customer = mysqli_fetch_assoc($sq_customer)){
	...
	$temp_arr = array("data" =>array(
		...
		'<button class="btn btn-info btn-sm" onclick="customer_display_modal('. $row_customer['customer_id'] .');btnDisableEnable(this.id)" id="customer_display_modal_view_btn'. $row_customer['customer_id'] .'" title="View Details" data-toggle="tooltip"><i class="fa fa-eye"></i></button>
		<button class="btn btn-info btn-sm" onclick="customer_update_modal('. $row_customer['customer_id'] .');btnDisableEnable(this.id)" id="customer_display_modal_edit_btn'. $row_customer['customer_id'] .'" title="Edit Details" data-toggle="tooltip"><i class="fa fa-pencil-square-o"></i></button>
		<button class="btn btn-info btn-sm" onclick="customer_history_modal('. $row_customer['customer_id'].' )" title="Download Outstanding Payment Summary" data-toggle="tooltip"><i class="fa fa-print"></i></button>'), "bg" => $bg
	);
