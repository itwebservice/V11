...
while($row_booking = mysqli_fetch_assoc($sq_booking)){
		...
		$temp_arr = array( "data" => array(
			...
			'<button class="btn btn-info btn-sm" onclick="bus_view_modal('. $row_booking['booking_id'] .')" id="view-'. $row_booking['booking_id'] .'" data-toggle="tooltip" title="View Details"><i class="fa fa-eye" aria-hidden="true"></i></button>',
			...
			'<button class="btn btn-info btn-sm" onclick="payment_view_modal('.$row_booking['booking_id'] .')" id="pview-'. $row_booking['booking_id'] .'"  data-toggle="tooltip" title="View Details"><i class="fa fa-eye" aria-hidden="true"></i></button>',
			number_format($bal_amount, 2),
			number_format($total_purchase,2),
			'<button class="btn btn-info btn-sm" onclick="supplier_view_modal('. $row_booking['booking_id'] .')" id="sview-'. $row_booking['booking_id'] .'" data-toggle="tooltip" title="View Details"><i class="fa fa-eye" aria-hidden="true"></i></button>',
			$branch_name,
			$emp_name,
