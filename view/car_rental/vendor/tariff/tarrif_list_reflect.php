            ...
            <table class="table table-bordered table-hover" id="tbl_vendor_list" style="margin: 20px 0 !important;">
                ...
                <tbody>
                    ...
                    <tr class="<?= $bg ?>">
                        ...
                        <td>
                            <button class="btn btn-info btn-sm" onclick="vendor_update_modal(<?= $row_venndor['entry_id'] ?>)" title="Update Details"><i class="fa fa-pencil-square-o"></i> </button>
                            <button class="btn btn-info btn-sm" onclick="vendor_view_modal(<?= $row_venndor['entry_id'] ?>)" title="View Details"><i class="fa fa-eye"></i></button>
                        </td>
                    </tr>
                    <?php
					}
