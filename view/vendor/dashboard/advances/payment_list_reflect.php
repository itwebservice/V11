...
while($row_payment = mysqli_fetch_assoc($sq_payment)){
	...
	$temp_arr = array( "data" => array(
		...
		''.$evidence.'
		<button class="btn btn-info btn-sm" onclick="payment_update_modal('.$row_payment['payment_id'] .')" data-toggle="tooltip" title="Update Details"><i class="fa fa-pencil-square-o"></i></button>'.
