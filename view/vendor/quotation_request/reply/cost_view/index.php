							...
							<div class="col-md-12">
								<div class="profile_box main_block">
										...
										<div class="row mg_bt_20">
											...
											<div class="col-md-6 mg_bt_10">
												<i class="fa fa-angle-double-right"></i>&nbsp;&nbsp;<label>HOTEL AMOUNT <em>:</em></label> <?= $sq_req['hotel_AMOUNT'] ?>
											</div>
											<?php }
											if($sq_req['quotation_for']!="Hotel Vendor"){ ?>
											<div class="col-md-6 mg_bt_10">
												<i class="fa fa-angle-double-right"></i>&nbsp;&nbsp;<label>TRANSPORT AMOUNT : </label> <?= $sq_req['transport_AMOUNT'] ?>
											</div>
											<?php }
											if($sq_req['quotation_for']=="DMC Vendor"){ ?>
											<div class="col-md-6 mg_bt_10">
												<i class="fa fa-angle-double-right"></i>&nbsp;&nbsp;<label>ACTIVITY AMOUNT <em>:</em></label> <?= $sq_req['excursion_AMOUNT'] ?>
											</div>
											<div class="col-md-6 mg_bt_10">
												<i class="fa fa-angle-double-right"></i>&nbsp;&nbsp;<label>VISA AMOUNT <em>:</em></label> <?=  $sq_req['visa_AMOUNT'] ?>
											</div>
											<?php }  ?>
											<div class="col-md-6 mg_bt_10">
												<i class="fa fa-angle-double-right"></i>&nbsp;&nbsp;<label>TOTAL AMOUNT <em>:</em></label> <?= $sq_req['total_AMOUNT'] ?>
											</div>
										</div>
										<div class="row mg_bt_10">
											<div class="col-md-12">
