                ...
                <div class="row">
                    <div class="panel panel-default panel-body app_panel_style feildset-panel mg_tp_20">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10_xs text-center">
                            ...
                            <input type="text" id="txt_adult_expense" title="Adult Cost" placeholder="Adult Cost" name="txt_adult_expense"
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10_xs text-center">
                            ...
                            <input type="text" id="txt_child_bed_expense" title="Child With Bed Cost" placeholder="Child With Bed Cost"
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10_xs text-center">
                            ...
                            <input type="text" id="txt_child_wbed_expense" title="Child Without Bed Cost" placeholder="Child Without Bed Cost" name="txt_child_wbed_expense" class="text-right" value="<?php echo $tourwise_details['child_without_bed'] ?>" onchange="calculate_total_discount(); validate_balance(this.id)" />
                        </div>
                        <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10_xs text-center">
                            <label>Infant Cost</label>
                            <input type="text" id="txt_infant_expense" title="Infant Cost" placeholder="Infant Cost" name="txt_infant_expense"
