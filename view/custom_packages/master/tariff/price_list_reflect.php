...
while($row_req = mysqli_fetch_assoc($sq_query_login)){
	...
	$temp_arr = array( "data" => array(
		...
		</form><button style="display:inline-block" class="btn btn-info btn-sm" onclick="view_modal(\''.$row_req['package_id'].'\')" data-toggle="tooltip" title="View Details"><i class="fa fa-eye"></i></button>
		'), "bg" => $bg);
