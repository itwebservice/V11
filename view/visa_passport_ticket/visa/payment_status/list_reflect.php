...
while($row_visa = mysqli_fetch_assoc($sq_visa)){
	...
	$temp_arr = array( "data" => array(
		...
		'<button class="btn btn-info btn-sm" onclick="visa_view_modal('. $row_visa['visa_id'] .');btnDisableEnable(this.id)" id="visa_view_modal_btn'. $row_visa['visa_id'] .'" data-toggle="tooltip" title="View Details"><i class="fa fa-eye" aria-hidden="true"></i></button>',
		...
		'<button class="btn btn-info btn-sm" onclick="payment_view_modal('.$row_visa['visa_id'] .');btnDisableEnable(this.id)" id="payment_view_modal_btn'. $row_visa['visa_id'] .'"  data-toggle="tooltip" title="View Details"><i class="fa fa-eye" aria-hidden="true"></i></button>',
		number_format($bal, 2),
		$due_date,
		number_format($total_purchase,2),
		'<button class="btn btn-info btn-sm" onclick="supplier_view_modal('. $row_visa['visa_id'] .');btnDisableEnable(this.id)" id="supplier_view_modal_btn'. $row_visa['visa_id'] .'" data-toggle="tooltip" title="View Details"><i class="fa fa-eye" aria-hidden="true"></i></button>',
		$branch_name,
		$emp_name,
